...
export const reverseLinkedList: Problem = {
  ...
  problemStatement: `<p className='mt-3'>Given the <code>head</code> of a singly linked list, reverse the list, and return <em>the reversed list</em>.</p>`,
  examples: [
    {
      id: 0,
  ...
  constraints: `<li className='mt-2'>The number of nodes in the list is the range <code>[0, 5000]</code>.</li><li className='mt-2'><code>-5000 <= Node.val <= 5000</code></li>`,
